...
var lyr_CostEfficiencyrupeeskm_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Cost Efficiency (rupees/km)<br><i>The <b>redder</b> the ward, the costlier the travel</i>' });
...
var lyr_Metrostationswheretheroadbelowgetsfloodedduringrainyseason_3 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Metrostationswheretheroadbelowgetsfloodedduringrainyseason_3.png" /> Metro stations where the road below gets<br>flooded during rainy season'
            });
...
var lyr_MetrostationswheretheroadbelowdoesNOTgetfloodedduringrainyseason_4 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/MetrostationswheretheroadbelowdoesNOTgetfloodedduringrainyseason_4.png" /> Metro stations where the road below does<br>NOT get flooded during rainy season'
            });
...
lyr_SafetyVulnerabilityScore_1.set('fieldImages', {'Ward Name': '', 'WardNumber': '', 'roads_Accident_Flood_Percentage of flood-prone roads': 'TextEdit', 'roads_Accident_Flood_Percentage of accident-prone roads': 'TextEdit', });

...
map.getView().fit([8480066.757139, 1105266.203078, 8507282.676252, 1126022.468684], map.getSize());
    ...
    element: (() => {
        ...
        if (198 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<h4>With the transportation theme, we aim to understand the<br> accessibility of the various modes of transport within Kochi,<br>encapsulating all three dimensions of sustainability<br>(environmental, economic, and social).</h4><b><i>Click on a ward to see information for it. <br />Click the top-right button to hide/reveal wards or points. <br />Navigate to the rest of themes with the links in the bottom left.</i></b><br>';
            }

            hideAbstract();
        } else {
            linkElement.classList.add("project-abstract-uncollapsed");
            linkElement.innerHTML = '<h4>With the transportation theme, we aim to understand the<br> accessibility of the various modes of transport within Kochi, encapsulating all three dimensions of sustainability<br>(environmental, economic, and social).</h4><b><i>Click on a ward to see information for it. <br />Click the top-right button to hide/reveal wards or points. <br />Navigate to the rest of themes with the links in the bottom left.</i></b><br>';
        }

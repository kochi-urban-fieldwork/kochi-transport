...
var Abstract = new ol.control.Control({
    element: (() => {
        ...
        if (198 > 240) {
            ...
            linkElement.classList.add("project-abstract-uncollapsed");
            linkElement.innerHTML = '<h4>With the transportation theme, we aim to understand <br>the accessibility of the various modes of transport within Kochi, encapsulating all three<br>dimensions of sustainability<br>(environmental, economic, and social).</h4><p style="font-size: 50px;">Click on a ward to see information for it. <br />Click the top-right button to hide/reveal wards or points. <br />Navigate to the rest of themes with the links in the bottom left.</p>';
        }

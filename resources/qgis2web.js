...
map.getView().fit([8481189.150209, 1106390.396690, 8505667.828187, 1125059.140117], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h1 class="project-title">Transportation Dashboard</h1>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (198 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<h4>With the Kochi Integrated Transportation Dashboard, we aim to understand the<br> accessibility of the various modes of transport within Kochi, encapsulating<br>all three dimensions of sustainability<br>(environmental, economic, and social).</h4><h5> Click on a ward to see information for it. <br />Click the top-right button to hide/reveal wards or points. <br />Navigate to the rest of themes with the links in the bottom left.</h5>';
            }

            hideAbstract();
        } else {
            linkElement.classList.add("project-abstract-uncollapsed");
            linkElement.innerHTML = '<h4>With the Kochi Integrated Transportation Dashboard, we aim to understand <br>the accessibility of the various modes of transport within Kochi, encapsulating all three<br>dimensions of sustainability<br>(environmental, economic, and social).</h4><h5>Click on a ward to see information for it. <br />Click the top-right button to hide/reveal wards or points. <br />Navigate to the rest of themes with the links in the bottom left.</h5>';
        }
